...
public class KIDSIPDataFeature extends KIDSAbstractAxiom implements KIDSFeature {

	public static final String name = "#KIDSIPPacketDataSignalDomain";
	public static final String iName = "#KIDSIPPacketData";
	public static final String parentDomain = "#KIDSPacketDataSignalDomain";
	KIDSContext myC;
	

	public KIDSIPDataFeature(OWLOntology o, IRI oIRI, OWLDataFactory f,
			OWLReasoner r) {
		super(o, oIRI, f, r);
	}
