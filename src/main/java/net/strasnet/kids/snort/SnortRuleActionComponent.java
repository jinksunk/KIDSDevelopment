 ...
 *
 */
public class SnortRuleActionComponent extends AbstractSnortRuleComponent {

	String value = "alert";
	
	public SnortRuleActionComponent(KIDSAddEventOracle ko,Set<IRI> currentSignalSet ) {
