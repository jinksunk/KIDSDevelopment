 ...
 */
public class KIDSUIDatasetViewComponent extends KIDSUIAbstractComponent implements KIDSUIComponent {
	
	public static final org.apache.logging.log4j.Logger logme = LogManager.getLogger(KIDSUIDatasetViewComponent.class.getName());
	...
	public KIDSUIDatasetViewComponent(IRI myID, KIDSGUIOracle o){
		super(myID, o);
