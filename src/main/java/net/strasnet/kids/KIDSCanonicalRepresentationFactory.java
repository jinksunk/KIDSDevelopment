 ...
 *
 */
public class KIDSCanonicalRepresentationFactory {

	
	public static KIDSCanonicalRepresentation createRepresentation (String className){
		...
		try {
			...
			return (KIDSCanonicalRepresentation) instance;
	...
	public static void main(String[] args) {
		...
		try {
			...
			newClass = Class.forName("net.strasnet.kids.signalRepresentations.KIDSSignalByteMatchRepresentation");
