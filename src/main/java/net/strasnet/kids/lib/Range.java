...
public final class Range <E extends Comparable<E>> {
  ...
  private static class Demo {
    private Range<Integer> threeToSeven = new Range<Integer>(3, 7);

    private void run() {

      Range<Integer> oneToFive = new Range<Integer>(1, 5);
      Range<Integer> oneToEleven = new Range<Integer>(9, 11);
      ...
      Range<Integer> degenerate = new Range<Integer>(9, 9);
