 ...
 *
 */
public class KIDSW3CBasicDataInstance extends AbstractDataInstance {
	...
	public KIDSW3CBasicDataInstance(Map<IRI, String> rMap) throws UnimplementedIdentifyingFeatureException{
		super(rMap, myIDs);
	}
