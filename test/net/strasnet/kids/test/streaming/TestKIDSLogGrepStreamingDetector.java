...
import net.strasnet.kids.streaming.KIDSGrepStreamingDetector;
...
public class TestKIDSLogGrepStreamingDetector {
	...
	public static String KIDSABOXFileLoc = "file://" + KIDSBASEFILELOC + "/resources/ontologies/testontologies/testKIDSStreamingEventViewerDetector.owl";
	...
	public static String grepExecute = "/usr/bin/grep";
	public static IRI detectorIRI = null;
	public static String monitorPoint = "/tmp/gtestnp1";
	...
	public static void setUpBeforeClass() throws Exception {
	    ...
	    detectorIRI = IRI.create(KIDSIndividualIRIPrefix + "#IISLogGrepRuleForCodeRed");
	    
	    signalsToMonitor = new HashSet<IRI>();
	    signalsToMonitor.add(IRI.create(KIDSIndividualIRIPrefix + "#HTTPGetRequestParameterSignal"));
	...
	public final void testTCPDumpMonitoring() {
		...
		try {
			KIDSGrepStreamingDetector t = new KIDSGrepStreamingDetector(grepExecute, detectorIRI, o, monitorPoint, signalsToMonitor, store);
	...
	public static void main(String[] argv){
		JUnitCore.runClasses(TestKIDSLogGrepStreamingDetector.class);
	}
